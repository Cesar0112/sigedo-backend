...
public class UserServiceImpl implements UserService {
	...
	public List<UserDto> listUsers() throws SQLException {
		...
		ResultSet rs = jdbcTemplate.getDataSource().getConnection().createStatement()
				.executeQuery("SELECT * FROM xuser");
	...
	public void updateUser(UserDto user) {
		...
		// Aqui implementar primero capturar a cual usuario se le quiere hacer los
		// cambios,
		// luego ver que cambios se le quiere hacer y hacer el update
		// primero ver si los cambios son validos antes de intentar corregirlos
		// ver si hubo cambios sino ni lo intentes
	...
	public UserDto getUserById(String userId) throws SQLException {
		...
		PreparedStatement pstmt = jdbcTemplate.getDataSource().getConnection()
				.prepareStatement("SELECT * FROM xuser where id = ?");
	...
	public void deleteUser(String userId) throws SQLException {
		...
		CallableStatement CS = jdbcTemplate.getDataSource().getConnection().prepareCall("{call delete_user(?)}");
